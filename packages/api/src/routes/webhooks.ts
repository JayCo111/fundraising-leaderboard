...
import { LeaderboardWorker } from '../workers/leaderboardWorker';
import { config } from '../config';
import { ApiResponse } from '@sportsraiser/core/types';

const router = Router();
const transactionService = new TransactionService();
const leaderboardWorker = new LeaderboardWorker();
...
async function handlePaymentCompleted(webhookData: any): Promise<void> {
  try {
...
async function handlePaymentRefunded(webhookData: any): Promise<void> {
  try {
...
function extractSellerFromPayment(paymentData: any): string | null {
...
function extractCampaignFromPayment(paymentData: any): string | null {
